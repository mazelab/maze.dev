...
#
#
class mazevpopqmail::qmail::install inherits mazevpopqmail::qmail::params
{
    ...
    file { "apply svscanboot":
        content     => template("$module_name/qmail/svscanboot.erb"),
    ...
    file { "apply qmail service script":
        content     => template("$module_name/qmail/qmailctl.erb"),
    ...
    file { "apply spamassassin defaults":
        ...
        content     => template("$module_name/qmail/spamd.defaults.erb"),
    ...
    file { "apply spamassassin configuration":
        ...
        content     => template("$module_name/qmail/spamd.local.cf.erb"),
    ...
    file { "apply qmail-scanner configuration":
        ...
        content     => template("$module_name/qmail/qms-config.erb"),
